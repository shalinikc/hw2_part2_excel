...
```bash
cookiecutter gh:shalinikc/cookiecutter-datascience-simple
```
...
For the remote repository, make a github repository named hw2_part2_excel, then do;

```bash
git remote add origin git@github.com:shalinikc/hw2_part2_excel.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── hw2_part2_excel	<- Your notebooks and scripts will live in the main project folder
